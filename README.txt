...
How To Use:
Up to you...but if you want to actually search for stuff in this archive, use the CodeTorch project I made! https://codetorch.net/en/projects/23062
...
- Projects first published on CodeTorch **before December 10, 2025** are licensed by their
  original authors under the **MIT License**.
- Projects first published on CodeTorch **on or after December 10, 2025** are licensed by their
  original authors under the **Creative Commons Attribution-ShareAlike 4.0 International (CC BY-SA 4.0)**.

This repository as a whole is licensed under **CC BY-SA 4.0**.
All original authors retain their respective copyrights.

Source URLs and author attribution are preserved in project metadata where available.
